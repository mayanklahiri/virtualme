...
ICONS=(house folder-kanban activity message-circle mail monitor menu x sun moon palette send square trash-2 copy check external-link triangle-alert bot terminal chevron-down chevron-right volume-2 play pause plus)
FONT_ROWS=(
