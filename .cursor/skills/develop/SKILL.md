...
Committed brand assets are `brand/wordmark.svg` (outlined Chakra Petch Bold
"Virtual" + fixed-red "me", regenerated by `scripts/gen-wordmark.mjs`
from a pinned TTF with the exact-pinned `opentype.js` devDependency),
